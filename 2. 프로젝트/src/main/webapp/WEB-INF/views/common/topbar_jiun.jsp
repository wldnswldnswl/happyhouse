...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3"
   ...
   <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
         ...
         <c:if test="${user!=null }">
         <li class="nav-item"> 
			<a class="nav-link text-secondary" href="#">${userName }님 로그인 중 </a>
			<a href="/logout" class="btn btn-success active" role="button">Login Out</a>
		</li>
         </c:if>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="user/login.do" method="get" id="loginForm">
               ...
               <div class="container form-group center-block"
                  style="display: inline-block; text-align: center; margin-bottom:0.5rem">
               ...
               <div class="container form-group center-block text-center"
               		...
               		<div>
               			<a class="" href="/oauth2/authorization/google">
               				...
               				<%--<img src="assets/img/login-with-google-icon-19.jpg" style="height:55px; width:254.32px;" >  --%>
               				<%--<img src="assets/img/google_login.png" style="height:55px; width:254.32px;" > --%>
               				<%--<div>구글 아이디로 로그인</div>--%>
               		    </a>
               		</div>
	        	
	        		<%-- <a class="row" href="/oauth2/authorization/google"><img src="assets/img/google_login.png" style="width:100%;"></a>
	            	<a class="row" href="/oauth2/authorization/naver"><img src="assets/img/naver_login.png" style="width:100%;"></a>--%>
	           	</div>
            </form>
         </div>
