...
<script>
	...
	function setMapCenter(lat,lng,viewSize)
	{	
		lat=Number(lat);
		lng=Number(lng);
	...
	<div class="container-fluid" style="margin-top: 100px">
		<div class="row" style="height: 900px;">
			<div class="col-sm-12">
				...
				<section id="index_section" class="form-inline align-center">
				<script>
				...
				function geocode(jsonData,viewSize) {
					var a = jsonData[0].lat;
					var b = jsonData[0].lng;
					setMapCenter(a,b,viewSize);
